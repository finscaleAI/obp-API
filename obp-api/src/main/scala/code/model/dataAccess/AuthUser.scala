...
import net.liftweb.util.Helpers._
  ...
  def agreePrivacyPolicy = {
    ...
    if (url.isEmpty) {
      ...
      scala.xml.Unparsed(s"""<div id="signup-agree-privacy-policy"><label>By submitting this information you consent to processing your data by Muellners Internet according to our <a href="$url" title="Privacy Policy">Privacy Policy</a>. Muellners Internet shall use this information to send you emails and provide customer support.</label></div>""")
    }
  }
